...
const ReviewConversationModal = V.memo(function ReviewConversationModal({
  ...
  const product = reviewConversationEntry.product || null;
  const clientName = String(
    (product && product.client_name) ||
      (reviewConversationEntry.review && reviewConversationEntry.review.client_name) ||
      'Cliente',
  ).trim() || 'Cliente';
  const productName = String((product && product.name) || 'Producto').trim() || 'Producto';
      ...
      children: [
        ...
        c.jsxs('div', {
          ...
          children: [
            ...
            c.jsxs('div', {
              className: 'flex items-center justify-between gap-3 rounded-xl border border-border-light dark:border-border-dark bg-white/85 dark:bg-slate-950/30 px-3 py-2',
              children: [
                c.jsxs('div', {
                  className: 'min-w-0',
                  children: [
                    ...
                    c.jsx('p', {
                      ...
                      children: 'Activa el switch para mandar el mismo comentario al usuario elegido.',
                    }),
                  ],
                }),
                c.jsx('button', {
