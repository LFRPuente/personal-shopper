...
function nh() {
  const initialAppRoute = V.useMemo(
    ...
    shipmentStatusFilter = shipmentsDomain.shipmentStatusFilter,
    setShipmentStatusFilter = shipmentsDomain.setShipmentStatusFilter,
    ...
    toggleAllShipmentProductSelections = shipmentsDomain.toggleAllShipmentProductSelections,
