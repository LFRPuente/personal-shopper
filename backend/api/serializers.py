...
class PublicStockCatalogProductSerializer(serializers.ModelSerializer):
    ...
    discount_uses_global = serializers.BooleanField(read_only=True)
...
class ShipmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            'package_length': {'required': False, 'allow_null': True},
            'package_width': {'required': False, 'allow_null': True},
            'package_height': {'required': False, 'allow_null': True},
            'package_weight': {'required': False, 'allow_null': True},
